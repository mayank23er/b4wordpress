...
class b4st_walker_nav_menu extends Walker_Nav_menu {
  ...
  function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ){ // li a span
    ...
    $classes = empty( $item->classes ) ? array() : (array) $item->classes;
		...
		$attributes .= ( $args->walker->has_children ) ? ' class="nav-link dropdown-toggle" data-toggle="dropdown" id="navbarDropdown" aria-haspopup="true" aria-expanded="false"' : ' class="nav-link nav-btn ptrip"';
...
//filter to add class and unset classes
