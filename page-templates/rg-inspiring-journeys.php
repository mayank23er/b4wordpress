<?php
/* 
Template Name: Inspiring Journeys
*/
get_header();
//header white js
...
<section class="exp-main story top-mb-5 top-section-margin popStory-margin">
        ...
        <div class="row">
            ...
            if(has_post_thumbnail()){
                $timagecm = wp_get_attachment_url( get_post_thumbnail_id(get_the_ID()) );
                if(strpos($timagecm,'cloudinary.com') > 0){
                    $timage =  str_replace("image/upload/","image/upload/c_fill,ar_1.44,f_auto,q_auto,w_1920,g_auto/",$timagecm);
                }else{
